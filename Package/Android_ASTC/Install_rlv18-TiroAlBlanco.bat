...
%ADB% %DEVICE% shell rm -r %STORAGE%/UnrealGame/VRRaulleonvalero
%ADB% %DEVICE% shell rm -r %STORAGE%/UnrealGame/UECommandLine.txt
%ADB% %DEVICE% shell rm -r %STORAGE%/obb/com.rlv18.TiroAlBlanco
%ADB% %DEVICE% shell rm -r %STORAGE%/Android/obb/com.rlv18.TiroAlBlanco
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.rlv18.TiroAlBlanco
...
%ADB% %DEVICE% shell pm grant com.rlv18.TiroAlBlanco android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.rlv18.TiroAlBlanco android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
